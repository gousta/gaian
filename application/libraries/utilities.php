...
class Utilities {
	...
	public static function timeAgo($time)
	{
		if($time > 0)
		{
			...
			if($difference < 10 && $periods[$j] == 'second') {
				return 'just now';
			}
			elseif($difference <= 1 && $periods[$j] == 'minute') {
	...
	public static function truncate($text, $length = 40)
	{
	...
	public static function country_code_to_country($code = null)
	{
		$country = '';
		...
		if( $code == 'CD' ) $country = 'Democratic Republic of the Congo';
		if( $code == 'CG' ) $country = 'Republic of the Congo';
