...
return array(
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| This key is used by the PayPal bundle to identify that money were
	| received by the proper account.
	|
	*/

	'paypal_receiver' => 'leoynage@gmail.com',
	...
	|--------------------------------------------------------------------------
	|
	| This key is used by the template file to create the form which will send
	| the user to PayPal and buy the item.
	|
	*/
	...
	*/
	...
	'key' => '30kf0kf0k3r01gk10k10gk10gk10g1g3',
